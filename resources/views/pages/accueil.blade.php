...
.editorial-hero:hover .hero-feature-bg { transform: scale(1.08); }
...
@media (max-width: 900px) {
    ...
    .hero-feature-content { padding: 32px 24px; }
...
@php
    $mainFeature = $featuredArticles->first();
    $secondaryFeatures = $featuredArticles->slice(1, 3);
@endphp
...
<section class="editorial-hero">
    <div class="editorial-hero-grid">
        ...
        <div class="hero-feature">
            @if($mainFeature)
            <div class="hero-feature-bg" style="background-image:url('{{ $mainFeature->medias->first()?->url ?? 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1400&q=80' }}');"></div>
            <div class="hero-feature-overlay"></div>
            <div class="hero-feature-content">
                <div class="hero-eyebrow">
                    <i class="fa-solid fa-star"></i>
                    {{ $mainFeature->categories->first()?->nom ?? 'À la Une' }}
                </div>
                <h1 class="hero-feature-title">{{ $mainFeature->titre }}</h1>
                <p class="hero-feature-excerpt">
                    {{ Str::limit($mainFeature->extrait ?? strip_tags($mainFeature->contenu), 160) }}
                </p>
                <a href="{{ route('culture.article', $mainFeature->slug) }}" class="hero-feature-cta">
        ...
        <div class="hero-list">
            ...
            @forelse($secondaryFeatures as $i => $article)
            <a href="{{ route('culture.article', $article->slug) }}" class="hero-list-item">
